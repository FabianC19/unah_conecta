...
// CORRECCIÓN: Convertimos a número para evitar errores de sobrecarga de métodos en Express
const PORT = Number(process.env.PORT) || 5000;

// CONFIGURACIÓN CORS: Acepta tanto solicitudes desde localhost como por dirección IP directa
app.use(cors({
...
// CONFIGURACIÓN DE ESCUCHA: Escuchando en la interfaz global '0.0.0.0' requerida por Docker
